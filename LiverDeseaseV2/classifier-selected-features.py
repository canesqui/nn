...
for header in ['Age','Total_Bilirubin','Direct_Bilirubin','Alkaline_Phosphotase','Alamine_Aminotransferase','Aspartate_Aminotransferase']:
...
model = tf.keras.Sequential([
  feature_layer,  
  layers.Dropout(0.25, input_shape=(6,)),
